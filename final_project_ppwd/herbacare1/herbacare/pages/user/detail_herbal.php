...
<div class="container py-5">
    <a href="herbal.php" class="buttonkembali">← Kembali ke Daftar Herbal</a>
    ...
    <div class="card mb-4">
        <?php if (!empty($herbal['gambar'])): ?>
            <img src="../../uploads/<?= htmlspecialchars($herbal['gambar']) ?>" alt="Gambar Herbal" 
            class="img-fluid rounded mb-3 d-block mx-auto" style="max-width: 400px; height: auto;">
        <?php endif; ?>
        <div class="card-body">
                ...
                <?php while ($k = mysqli_fetch_assoc($komentar_query)): ?>
                    <div class="komentar-box mb-3">
                        <div class="d-flex justify-content-between">
                            <div>
                                <strong>
                                    <a href="viewprofile.php?id=<?= $k['user_id'] ?>" class="text-decoration-none">
                                         <?= htmlspecialchars($k['username']) ?>
                                    </a>
                                </strong>
                                <span class="badge bg-secondary"><?= htmlspecialchars($k['role']) ?></span>
